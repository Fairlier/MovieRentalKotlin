...
import com.example.movierentalkotlin.viewmodelfactory.employee.InsertEmployeeViewModelFactory
...
class InsertEmployeeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.menuToolbar.setNavigationOnClickListener {
            navController.navigate(InsertEmployeeFragmentDirections.actionInsertEmployeeFragmentToEmployeeCatalogFragment())
        }
        ...
        viewModel.navigateToCatalogAfterInsert.observe(viewLifecycleOwner) { navigate ->
            if (navigate) {
                val action =
                    InsertEmployeeFragmentDirections.actionInsertEmployeeFragmentToEmployeeCatalogFragment()
