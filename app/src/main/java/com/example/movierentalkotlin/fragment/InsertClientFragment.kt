...
import com.example.movierentalkotlin.viewmodelfactory.InsertClientViewModelFactory
...
class InsertClientFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.menuToolbar.setNavigationOnClickListener {
            navController.navigate(InsertClientFragmentDirections
                .actionInsertClientFragmentToClientCatalogFragment())
        }
        ...
        viewModel.navigateToCatalogAfterInsert.observe(viewLifecycleOwner) { navigate ->
            if (navigate) {
                val action = InsertClientFragmentDirections
                    .actionInsertClientFragmentToClientCatalogFragment()
