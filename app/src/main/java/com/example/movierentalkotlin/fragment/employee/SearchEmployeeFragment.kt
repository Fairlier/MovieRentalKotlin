...
class SearchEmployeeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.menuToolbar.setNavigationOnClickListener {
            navController.navigate(SearchEmployeeFragmentDirections.actionSearchEmployeeFragmentToEmployeeCatalogFragment())
        }
        ...
        viewModel.navigateToCatalogAfterSearch.observe(viewLifecycleOwner) { navigate ->
            if (navigate) {
                ...
                val action =
                    SearchEmployeeFragmentDirections.actionSearchEmployeeFragmentToEmployeeCatalogFragment()
