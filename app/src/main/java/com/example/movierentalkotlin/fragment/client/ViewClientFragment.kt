...
import com.example.movierentalkotlin.viewmodelfactory.client.ViewClientViewModelFactory
...
class ViewClientFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                return when (menuItem.itemId) {
                    R.id.editClientFragment -> {
                        ...
                        val action =
                            ViewClientFragmentDirections.actionViewClientFragmentToEditClientFragment(
                                currentId
                            )
        ...
        binding.menuToolbar.setNavigationOnClickListener {
            navController.navigate(ViewClientFragmentDirections.actionViewClientFragmentToClientCatalogFragment())
        }
    }
